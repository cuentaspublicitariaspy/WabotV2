...
<div class="mb-6"><h2 class="text-base font-semibold text-slate-800 mb-3">Prospectos</h2><div id="prospect-cards" class="grid grid-cols-2 md:grid-cols-4 gap-4"></div></div>
