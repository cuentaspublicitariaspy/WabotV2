    ...
    <div class="px-6 pb-5 shrink-0">
        <div class="bg-slate-50 rounded-2xl p-5 border border-slate-100">
            ...
            <div class="flex gap-3 flex-wrap">
                ...
                <a href="plantillas.php" class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-50 transition shadow-sm">
