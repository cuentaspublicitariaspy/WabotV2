...
const ACCESS_CODE_HASH = '41f75ebe668d2b6c0ffd7a49faeed10f08c044aa47a5b11bab8cc77ae77ac601';
const QUALITY_EMAIL = 'calidad.wc.20260715@wabot.local';
...
try {
    ...
    if (!$exists->fetchColumn()) {
        ...
        $add->execute(['Control de Calidad WC', QUALITY_EMAIL, password_hash($password, PASSWORD_DEFAULT), 'super_admin']);
    }
